...
namespace PalettePal
{
    public static class ColorConversion
    {
        ...
        public static Vector3 RgbToXyz(Vector3 rgb)
        {
            ...
            return new Vector3(
                0.436052025f * rgb[0] + 0.385081593f * rgb[1] + 0.143087414f * rgb[2],
                0.222491598f * rgb[0] + 0.71688606f * rgb[1] + 0.060621486f * rgb[2],
                0.013929122f * rgb[0] + 0.097097002f * rgb[1] + 0.71418547f * rgb[2]
            );
        }
